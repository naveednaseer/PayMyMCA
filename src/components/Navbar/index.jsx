...
export default function Navbar() {
  ...
  return (
    <nav className={classNames('fixed w-full transition-all duration-700 z-10 py-8 ', {
      ...
      <div className="px-4 container mx-auto top-0 flex justify-around items-center">
      {/* <div className="px-4 container mx-auto top-0 flex justify-between items-center"> */}
      <a href='/home'>
          <img src={pmmlogo} className="mr-2 w-40" alt="Logo" />
      </a>
        
        <div className="flex items-center">
          {/* <img src={logo} className="mr-6 w-12" alt="Neva" /><span className='font-bold text-4xl'>PMM</span> */}
          <div className='hidden mx-8 gap-8 xl:flex'>
            <Menus />
          </div>
        </div>
