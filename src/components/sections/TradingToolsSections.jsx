          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className='lg:row-start-1 max-w-lg'>
              ...
              <div className="mb-6">
                ...
                <br></br>
                <p className='text-gray'>Achieve a debt-free future with our proven strategies.
                  Say goodbye to bankruptcy fears, legal battles, and
                  attorney fees. Embrace a straightforward business
                  approach that eliminates debt effectively, ensuring
                  financial freedom and success.
                </p>
                <br></br>
                <p className='text-gray'>Act now and take control of your future!
                </p>
              </div>
